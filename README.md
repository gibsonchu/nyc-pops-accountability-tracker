...
| `data/processed/pops_tracker.sqlite` (generated by `build`, not committed) | The history data model ([schema](data/schema/pops_history.sql)): agreement → requirements → audit → enforcement, with empty tables ready for inspections, 311, modifications, building records |
